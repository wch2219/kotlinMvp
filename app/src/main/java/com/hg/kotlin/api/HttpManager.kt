   ...
   private var mHttpManager: HttpManager? = null
    ...
    fun init(context: Context) {
        ...
        var httpClient = OkHttpClient.Builder()
            ...
            .addInterceptor(OkHttpInterce.getRequestHeader(context))
    ...
    companion object {
        ...
        private var mServer:ApiServer ?=null
        fun getRequest(server: Class<ApiServer>):ApiServer?{
            if ( mServer== null) {
                synchronized(server){

                    mServer = retrofits?.create(server)
                }
            }
        return mServer
        }
